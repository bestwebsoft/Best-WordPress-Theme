	...
	<section class="best-contents">
		<?php if ( have_posts() ) {
			...
			if ( is_home() && current_user_can( 'publish_posts' ) ) { ?>
				...
				<p><?php _e( 'Sorry, but nothing matches your search terms. Please try again using different keywords.', 'best' ); ?></p> <?php 
				get_search_form();
			} else { ?>
				<p><?php _e( 'The page you are looking for is not found. Maybe try a search?', 'best' ); ?></p> <?php 
				get_search_form();
			} 
		} // if have_posts() ?>
